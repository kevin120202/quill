...
function Register() {
    return (
        <div className="container mx-auto flex flex-col gap-10">
            ...
            <h1 className="text-center text-3xl md:text-4xl font-bold">Welcome Aboard</h1>
            <form className="flex flex-col gap-6 items-center w-[60%] mx-auto">
                <label htmlFor="" className="text-gray-700 text-sm font-bold w-full">
                    First Name
                    <input type="text" className="border border-rounded w-full py-1 px-2 font-normal border-black"
                    />
                </label>
